...
usage() {
  ...
  echo "  ./scripts/master.sh start [master1|master2|master3] [KEY=VALUE ...]"
  echo "  ./scripts/master.sh restart [master1|master2|master3] [KEY=VALUE ...]"
  echo "  ./scripts/master.sh rebuild [master1|master2|master3] [KEY=VALUE ...]"
  echo "  ./scripts/master.sh update [master1|master2|master3] [KEY=VALUE ...]"
  echo "  ./scripts/master.sh stop [master1|master2|master3]"
  echo "  ./scripts/master.sh logs [master1|master2|master3]"
  echo "  ./scripts/master.sh shell [master1|master2|master3]"
  echo ""
  echo "Cluster:"
  echo "  ./scripts/master.sh start-all [KEY=VALUE ...]"
  echo "  ./scripts/master.sh restart-all [KEY=VALUE ...]"
  echo "  ./scripts/master.sh rebuild-all [KEY=VALUE ...]"
  echo "  ./scripts/master.sh update-all [KEY=VALUE ...]"
  echo "  ./scripts/master.sh stop-all"
  echo "  ./scripts/master.sh ps"
  echo "  ./scripts/master.sh reset-raft"
  echo ""
  echo "Example:"
  echo "  ./scripts/master.sh rebuild-all MASTER_CLUSTER_HOST=172.31.37.47"
  exit 1
}
